...
const TOUR_STEPS = [
  { sel: ".verdict", title: "Світлофор норми", text: "Угорі — миттєвий вердикт: зелений «Відповідає», жовтий «Гранично», червоний «Не відповідає». Поруч — список порушень із пунктом ДБН і порадою, як виправити." },
            ...
            <div className="sliders">
              ...
              <div>
                <SwitchRow name="Дитячий поручень 0,50 м" hint="третій рівень для закладів із дітьми (п. 5.3.2)"
                  help="Додає третій нижній поручень на висоті 0,50 м — щоб за нього могла взятися дитина або людина низького зросту. Потрібен у школах і дитячих закладах."
            ...
            <div className="sliders">
              ...
              <div>
                <SwitchRow name="Покриття тверде, рівне, без фаски" hint="п. 5.1.7"
                  help="Покриття має бути тверде й рівне, без вибоїн і скосів (фасок), щоб колеса не застрягали і не прослизали. Вимкніть, щоб побачити порушення."
                ...
                <SwitchRow name="Контрастна смуга ≥ 0,10 м" hint="на межах кожного маршу (п. 5.3.2.4)"
                  help="Яскрава контрастна смуга (мін. 0,10 м) на початку й в кінці кожного маршу — щоб людина зі слабким зором помітила початок схилу."
